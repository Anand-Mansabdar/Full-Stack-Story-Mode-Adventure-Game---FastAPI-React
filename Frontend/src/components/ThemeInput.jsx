  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm font-medium mb-6 animate-fade-in-up-delay-1">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-extrabold tracking-tight mb-4 animate-fade-in-up-delay-1">
          ...
          <span className="text-slate-600 dark:text-slate-300">Adventure</span>
        </h1>

        <p className="text-lg text-slate-500 dark:text-slate-400 max-w-lg mx-auto leading-relaxed animate-fade-in-up-delay-2">
          Enter a theme and watch AI weave an interactive branching story where
      ...
      <div className="max-w-xl mx-auto animate-fade-in-up-delay-3">
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 p-8">
          <form onSubmit={handleSubmit}>
            ...
            <div
              className={`relative rounded-xl transition-all duration-300 ${isFocused ? "ring-2 ring-slate-400 ring-offset-2 ring-offset-white dark:ring-offset-slate-800" : ""}`}
            >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {suggestions.map((s) => (
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-medium rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600 hover:text-slate-700 dark:hover:text-slate-200 border border-transparent hover:border-slate-300 dark:hover:border-slate-500 transition-all duration-200 cursor-pointer"
                >
                  {s}
                </button>
              ))}
            ...
            <button
              ...
              className="mt-6 w-full py-4 px-6 bg-slate-700 hover:bg-slate-600 dark:bg-slate-600 dark:hover:bg-slate-500 text-white font-semibold text-base rounded-xl shadow-lg shadow-slate-500/20 hover:shadow-slate-500/30 transform hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-800 cursor-pointer flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
